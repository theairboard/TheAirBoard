...
public class ColorCircle extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mTrackingCenter) {
            ...
            // The skinny ring around the center to indicate that it is being
            // pressed
        ...
        if (this.isClickable()) {
            ...
            case MotionEvent.ACTION_MOVE:
                if (mTrackingCenter) {
                    ...
                    newcolor = interpColor(mColors, unit);
            ...
            case MotionEvent.ACTION_UP:
                ...
                try {
                    mFunction.invoke(mParent, newcolor);
                } catch (Exception e) {
                    e.printStackTrace();
                }
                break;
    ...
    public void setFunction(Activity parent, String functionName) {
        try {
            mFunction = parent.getClass().getMethod(functionName, new Class[] { int.class });
