/*
BrushBot/Airship proportional control
...
void loop() { 
  RemoteXY_Handler();
  analogWrite(RIGHT, map(RemoteXY.joystick_1_x, -100, 100, 0, 255)); // drive right motor from 0 to 255
  analogWrite(LEFT, map(RemoteXY.joystick_1_y, -100, 100, 0, 255));  // drive left motor from 0 to 255
}
